...
/**
 * REST controller for managing {@link com.reactnatjhip.developer.domain.Company}.
 */
@RestController
@RequestMapping("/api")
public class CompanyResource {
    ...
    public Mono<ResponseEntity<Company>> createCompany(@RequestBody Company company) throws URISyntaxException {
